    ...
    <div class="register">
        <h2>Register</h2>
                    <?php 
                            ...
                            $favoritecolor1 = $_POST['favcolor1'];
                            $favoritecolor2 = $_POST['favcolor2'];
                            $favoritecolor3 = $_POST['favcolor3'];
                            ...
                            $sql = "INSERT INTO user(name,email,favcolor1,favcolor2,favcolor3,skintone,bdate,gender,usercountry,pass)
                              VALUES('$username','$emailadd','$favoritecolor1','$favoritecolor2','$favoritecolor3','$skintone','$birthdate','$gender','$usercountry','$password')";
              ...
              <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                 <div class="col-md-6  register-top-grid">
                    ...
                    <div class="mation">
                        ...
                        <input type="email" name="email"  class="two">

                        <span>Skin Tone</span>
                        <select class= "list" name='skintone' style="text-decoration-color: #ffffff">
                            <option selected="selected" value="">Select...</option>
                            <option value="1" style="background-color:bisque">Fair/Pink</option>
                            <option value="2" style="background-color:navajowhite">White</option>
                            <option value="3" style="background-color:burlywood">Wheatish/Beige</option>
                            <option value="4" style="background-color:peru">Tanned/Brown</option>
                            <option value="5" style="background-color:saddlebrown">Black</option>
                        </select>                         
                        ...
                        <span>Country</span>
                        <select class= "list" name="usercountry">
                            <option selected="selected" value="">Select...</option>
                        ...
                        <select class= "list" name='favcolor' multiple="multiple">
                            <option selected="selected" value="">Select...</option>
                        ...
                        <input class="list" type="date" name="bdate">
                     ...
                     <div class=" col-md-6 register-bottom-grid">
                            ...
                            <div class="mation">
                                ...
                                <input type="password" name="cpassword" maxlength="40">
                            </div>
                     </div>
                     <div class="clearfix"> </div>
